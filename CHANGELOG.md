...
### Added
- Pure C implementations of AES-256-CBC and SHA-256.
- Unified High-Precision C Benchmarking API (`clock_gettime`).
- Python FFI Bridge using `ctypes` for automatic library discovery.
- Concurrency harness supporting both `threading` and `multiprocessing`.
